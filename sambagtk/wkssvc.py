...
class wkssvcConnectDialog(ConnectDialog):
    def __init__(self, server, transport_type, username, password):
        ...
        self.set_title(_("Connect to Samba Server"))
...
class DomainJoinDialog(Gtk.Dialog):
    ...
    def create(self):
        ...
        self.set_title(_("Join a Domain"))
        ...
        frame = Gtk.Frame()
        label = Gtk.Label(_("<b>Domain Details</b>"))
        ...
        label = Gtk.Label(_("Domain Name:"), xalign=1, yalign=0.5)
        ...
        label = Gtk.Label(_("Machine Name:"), xalign=1, yalign=0.5)
        ...
        self.machine_name_entry.set_tooltip_text(
                _("Enter the NetBIOS/Hostname of the Machine "
                    "in the concerned domian"))
        grid.attach(self.machine_name_entry,  1, 2, 1, 1)

        # User Creds frame
        frame = Gtk.Frame()
        label = Gtk.Label(_("<b>User Credentials</b>"))
        label.set_property('use-markup',True)
...
class DeleteDialog(Gtk.Dialog):
    ...
    def create(self):
        """ Create the window """
        title = "Unjoin Domain %s" % self.domain_name
        ...
        box = Gtk.VBox(3)
        label = Gtk.Label(_("Are yous sure you want to continue ?"),
