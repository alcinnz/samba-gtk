...
setup(
    ...
    data_files=[ ('/usr/share/applications', ['meta/gepdump.desktop',
                                         'meta/gregedit.desktop',
                                         'meta/gtkldb.desktop']),
                 ('/usr/share/samba-gtk', ['logos/samba-logo-small.png',
                                            'logos/samba-logo-square.png']),
                 ('/usr/share/icons/hicolor/48x48/apps', ['logos/samba.png']),
                 ('/usr/share/man/man1', ['man/gepdump.1',
                                     'man/gtkldb.1',
                                     'man/gregedit.1'])],
